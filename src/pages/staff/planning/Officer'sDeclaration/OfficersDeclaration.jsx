...
const OfficersDeclaration = ({
  labels = {
    declaration: "Appraisee's Declaration ",
    date: "Date:",
    signature: "Countersigning Officer's Signature :",
  },
}) => {
  ...
  return (
    <div className="flex flex-wrap bg-white border-b-2 border-gray-400">
      ...
      <SignatureField label={labels.signature} showButton={false} />
    </div>
  );
};

export default OfficersDeclaration;
