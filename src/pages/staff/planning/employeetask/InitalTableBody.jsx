...
const InitalTableBody = ({ tasksData, rows = [], setRows, onAddNestedRow }) => {
  ...
  return (
    <form>
      <TableHeader selectedTab={selectedTab} onTabChange={handleTabChange} />
      <tbody>
...
export default InitalTableBody;
